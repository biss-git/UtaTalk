...
namespace VSLIB.NET
{
    ...
    public class Item
    {
        ...
        {
            Project.LastErrorCode = VSFunction.VslibGetStretchEditSec(Project.hVsprj, Index, timeOrg_Sec, out double timeEdt_Sec);
            return timeEdt_Sec;
        }
        /// <summary>
        /// タイムストレッチ前時間を取得[サンプル]
        ...
        {
            Project.LastErrorCode = VSFunction.VslibGetStretchEditSample(Project.hVsprj, Index, timeOrg_Sample, out double timeEdt_Sample);
